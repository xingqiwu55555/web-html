...
[事件循环(Event Loop)](https://github.com/xingqiwu55555/web-html/tree/master/base-tech/javascript\&es6\&es7/event-loop.md)
...
3. undefined、null 转为布尔值时为 false，==返回true，===返回false；
